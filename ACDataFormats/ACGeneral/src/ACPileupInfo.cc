...
ACPileupInfo::ACPileupInfo(const int num_PU_vertices, std::vector<float>& zpositions, std::vector<float>& sumpT_lowpT, std::vector<float>& sumpT_highpT, std::vector<int>&   ntrks_lowpT, std::vector<int>&   ntrks_highpT, int bunchCrossing) {
    num_PU_vertices_ =  num_PU_vertices;
    zpositions_.clear();
    sumpT_lowpT_.clear();
    sumpT_highpT_.clear();
...
ACPileupInfo::ACPileupInfo(const int num_PU_vertices, std::vector<float>& zpositions, std::vector<float>& sumpT_lowpT, std::vector<float>& sumpT_highpT, std::vector<int>&   ntrks_lowpT, std::vector<int>&   ntrks_highpT, int bunchCrossing, float TrueNumInteractions) {
    num_PU_vertices_ =  num_PU_vertices;
    zpositions_.clear();
    sumpT_lowpT_.clear();
    sumpT_highpT_.clear();
...
//ACPileupInfo::ACPileupInfo(const int num_PU_vertices,
